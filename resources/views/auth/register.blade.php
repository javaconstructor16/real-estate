                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="address" id="address" cols="30" rows="10" class="form-control">{{ old('phone') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="checkbox">
                                    <label><input type="checkbox" id="checkbox" checked> Get update by newsletter</label>
                                </div>
                        ...
                        <input name="newsletter" id="newsletter" type="hidden" value="1">
